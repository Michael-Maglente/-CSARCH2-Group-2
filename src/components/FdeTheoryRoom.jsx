...
export default function FdeTheoryRoom() {
    ...
    const handleInputChange = (q, value) => {
        ...
        setError(false); // Reset error state on typing
    };

    const submitFlags = () => {
        const isQ1Correct = answers.q1.trim().toLowerCase() === 'fetch';
        const isQ2Correct = answers.q2.trim().toLowerCase() === 'decode';
        const isQ3Correct = answers.q3.trim().toLowerCase() === 'execute';
    ...
    return (
        <div style={{
            ...
            {/* TASK HEADER */}
            <div style={{ backgroundColor: '#020204', padding: '15px 20px', borderBottom: '1px solid #004d66', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <span style={{ color: '#febe0b', fontWeight: 'bold', fontSize: '1.1rem' }}>
                    TASK 1: UNDERSTANDING THE CPU PIPELINE
                </span>
                <span style={{ color: roomCleared ? '#00bafa' : '#537a85', fontSize: '0.9rem' }}>
            ...
            <div style={{ padding: '25px' }}>
                ...
                <div style={{ color: '#c0f3ff', fontSize: '0.9rem', lineHeight: '1.6', marginBottom: '30px', padding: '15px', background: 'rgba(0, 77, 102, 0.1)', borderLeft: '3px solid #00bafa' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '15px', marginBottom: '25px' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                        ...
                        <input 
                            ...
                            style={{ background: '#020204', border: '1px solid #004d66', color: '#00bafa', padding: '10px', fontFamily: 'inherit', outline: 'none', width: '250px' }}
                        />
                    </div>
                    {/* Q2 */}
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                ...
                {!roomCleared ? (
                    <div style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
                        ...
                        {error && <span style={{ color: '#fe006f', fontSize: '0.85rem' }}>[!] ACCESS DENIED: Incorrect flags detected. Review the briefing.</span>}
                    </div>
                ) : (
